...
public class HelloSpiritItem extends AllOfBugsModElements.ModElement {
	@ObjectHolder("all_of_bugs:hello_spirit")
	public static final Item block = null;
	public HelloSpiritItem(AllOfBugsModElements instance) {
		super(instance, 12);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("No.\u00A7a006"));
		}
	}
}
