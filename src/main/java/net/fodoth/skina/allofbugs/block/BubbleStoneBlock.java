...
import net.fodoth.skina.allofbugs.procedures.BubbleStoneKeHuDuanXianShiSuiJiKeProcedure;
...
public class BubbleStoneBlock extends AllOfBugsModElements.ModElement {
	@ObjectHolder("all_of_bugs:bubble_stone")
	public static final Block block = null;
	public BubbleStoneBlock(AllOfBugsModElements instance) {
		super(instance, 72);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("No.\u00A7a012"));
		}
		...
		public void animateTick(BlockState blockstate, World world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				BubbleStoneKeHuDuanXianShiSuiJiKeProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
