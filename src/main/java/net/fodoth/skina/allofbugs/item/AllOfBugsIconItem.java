...
public class AllOfBugsIconItem extends AllOfBugsModElements.ModElement {
	@ObjectHolder("all_of_bugs:all_of_bugs_icon")
	public static final Item block = null;
	public AllOfBugsIconItem(AllOfBugsModElements instance) {
		super(instance, 1);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("all_of_bugs_icon");
		}
