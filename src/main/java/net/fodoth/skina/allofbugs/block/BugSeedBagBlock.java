...
import net.fodoth.skina.allofbugs.procedures.BugSeedBagZuZhiYouXiaoDeFangZhiTiaoJianProcedure;
...
public class BugSeedBagBlock extends AllOfBugsModElements.ModElement {
	@ObjectHolder("all_of_bugs:bug_seed_bag")
	public static final Block block = null;
	public BugSeedBagBlock(AllOfBugsModElements instance) {
		super(instance, 69);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Bug.\u00A7c011"));
		}
		...
		public boolean isValidPosition(BlockState blockstate, IWorldReader worldIn, BlockPos pos) {
			if (worldIn instanceof IWorld) {
				...
				int y = pos.getY();
				int z = pos.getZ();
				return BugSeedBagZuZhiYouXiaoDeFangZhiTiaoJianProcedure.executeProcedure(ImmutableMap.of("x", x, "y", y, "z", z, "world", world));
			}
