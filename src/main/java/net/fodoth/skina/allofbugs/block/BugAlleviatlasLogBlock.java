...
public class BugAlleviatlasLogBlock extends AllOfBugsModElements.ModElement {
	@ObjectHolder("all_of_bugs:bug_alleviatlas_log")
	public static final Block block = null;
	public BugAlleviatlasLogBlock(AllOfBugsModElements instance) {
		super(instance, 17);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("bug_alleviatlas_log");
		}
