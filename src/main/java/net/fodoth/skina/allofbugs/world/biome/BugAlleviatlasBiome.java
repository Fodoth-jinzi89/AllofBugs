...
package net.fodoth.skina.allofbugs.world.biome;
...
import net.fodoth.skina.allofbugs.block.BugEnchantedHerbaGrassBlock;
import net.fodoth.skina.allofbugs.block.BugAlleviatlasLogBlock;
import net.fodoth.skina.allofbugs.block.BugAlleviatlasLeavesBlock;
...
public class BugAlleviatlasBiome extends AllOfBugsModElements.ModElement {
	public static Biome biome;
	public BugAlleviatlasBiome(AllOfBugsModElements instance) {
		super(instance, 31);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder().withSurfaceBuilder(
						SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(BugEnchantedHerbaGrassBlock.block.getDefaultState(),
								BugEnchantedHerbaGrassBlock.block.getDefaultState(), BugEnchantedHerbaGrassBlock.block.getDefaultState())));
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration(
								(new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(BugAlleviatlasLogBlock.block.getDefaultState()),
										new SimpleBlockStateProvider(BugAlleviatlasLeavesBlock.block.getDefaultState()),
				...
				event.getRegistry().register(biome.setRegistryName("all_of_bugs:bug_alleviatlas"));
			}
		}
	}
	@Override
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("bug_alleviatlas_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("bug_alleviatlas_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
		@Override
		protected TreeDecoratorType<?> func_230380_a_() {
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("bug_alleviatlas_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
