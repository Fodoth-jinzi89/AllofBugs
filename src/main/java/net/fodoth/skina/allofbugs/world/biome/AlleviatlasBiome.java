...
import net.fodoth.skina.allofbugs.block.EnchantedHerbaGrassBlock;
import net.fodoth.skina.allofbugs.block.AlleviatlasLogBlock;
import net.fodoth.skina.allofbugs.block.AlleviatlasLeavesBlock;
...
public class AlleviatlasBiome extends AllOfBugsModElements.ModElement {
	public static Biome biome;
	public AlleviatlasBiome(AllOfBugsModElements instance) {
		super(instance, 27);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder().withSurfaceBuilder(
						SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(EnchantedHerbaGrassBlock.block.getDefaultState(),
								EnchantedHerbaGrassBlock.block.getDefaultState(), EnchantedHerbaGrassBlock.block.getDefaultState())));
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION,
						Feature.TREE
								.withConfiguration(
										(new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(AlleviatlasLogBlock.block.getDefaultState()),
												new SimpleBlockStateProvider(AlleviatlasLeavesBlock.block.getDefaultState()),
				...
				event.getRegistry().register(biome.setRegistryName("all_of_bugs:alleviatlas"));
			}
		}
	}
	@Override
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("alleviatlas_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("alleviatlas_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
		@Override
		protected TreeDecoratorType<?> func_230380_a_() {
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("alleviatlas_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
