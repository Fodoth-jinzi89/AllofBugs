...
public class AlleviatlasLogBlock extends AllOfBugsModElements.ModElement {
	@ObjectHolder("all_of_bugs:alleviatlas_log")
	public static final Block block = null;
	public AlleviatlasLogBlock(AllOfBugsModElements instance) {
		super(instance, 16);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("alleviatlas_log");
		}
