...
public class TimeBombItem extends AllOfBugsModElements.ModElement {
	@ObjectHolder("all_of_bugs:time_bomb")
	public static final Item block = null;
	public TimeBombItem(AllOfBugsModElements instance) {
		super(instance, 44);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("No.\u00A7a008"));
		}
	}
}
